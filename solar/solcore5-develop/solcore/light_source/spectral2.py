...
def get_default_spectral2_object():
    """ Returns a default state object for use with calculate_spectrum. Parameters returned are for:
        返回一个默认状态对象用于calculate_spectrum。返回的参数为：
        - Coventry (52.39°N,-1.56°E)        # 地点：考文垂（位于英国中部）(52.39°N,-1.56°E)
        - for 12:30 pm on the 30th of June 2011 (that's in the future!) (not any more..)    #日期时间
        - rural atmospheric conditions      # 大气条件
        - 30% humidity                      # 30%湿度
        - 1.42mm precipitated water         # 1.42毫米沉淀水
        - 1030 hPa atmospheric pressure     # 大气压力
        - 0.34mm of Ozone                   # 0.34毫米的臭氧
        - turbidity of 15%.                 # 浊度为15%
    """
    defaults = {}
