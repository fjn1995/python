...
def reference_spectra():
    """ Function providing the standard reference spectra: AM0, AM1.5g and AM1.5d. 提供标准参考光谱的函数
    ...
    science_reference(
        ...
        "ASTM G173-03(2012), Standard Tables for Reference Solar Spectral Irradiances: "    #光谱强度
...
class LightSource:
    ...
    def __init__(self, source_type, x=None, output_units = "power_density_per_nm", concentration=1, **kwargs):
        ...
        assert source_type in self.type_of_source, msg  #断言a，否则msg 提示信息
    ...
    def spectrum(self, x=None, output_units=None, concentration=None, **kwargs):
        ...
        J or hz.它必须是一个具有光谱范围的阵列，在其中计算光谱
    ...
    def _get_spectral2_spectrum(self, options):
        """ Get the solar spectrum calculated with the SPECTRAL2 calculator.
        The options dictionary is updated with the default options of all parameters if they are not provided.
        让我们用SPECTRAL2计算器计算太阳光谱。
        如果未提供所有参数的默认选项，则使用它们更新选项字典。
...
@register_conversion_function   #函数装饰器
